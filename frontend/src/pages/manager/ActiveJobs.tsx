      ...
      <section className="production-layout">
              ...
              {filtered.length === 0 ? (
                ...
                >
                  ...
                  <div className="card-actions">
                    <button
                      className="btn"
                      onClick={(e) => { e.stopPropagation(); navigateTopLevel(`work-view-${j.id.replace('Job #', '')}`); }}
                    >
                      Open Work View
                    </button>
                  </div>
        ...
        {selectedJob && (
          <aside className="box" style={{ alignSelf: 'flex-start', position: 'sticky', top: 18 }}>
            ...
            <button className="btn primary block" style={{ marginTop: 4 }} onClick={() => navigateTopLevel(`work-view-${selectedJob.id.replace('Job #', '')}`)}>
              Open Work View
            </button>
          </aside>
        )}
